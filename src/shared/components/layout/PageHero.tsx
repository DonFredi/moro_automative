...
export function PageHero({
  ...
  return (
    <section className="relative flex min-h-[320px] items-center overflow-hidden">
      ...
      />
      <div className="section-wrapper relative w-full z-10 py-12 text-left">
        <Breadcrumbs labels={breadcrumbLabels} light />
        <div className="eyebrow mb-2.5 text-accent">{eyebrow}</div>
        <h1 className="mb-3.5 font-heading text-[32px] leading-tight text-white md:text-[46px]">{title}</h1>
