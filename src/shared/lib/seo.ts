...
/**
 * Every page/layout calls this with ONLY the fields that differ from the
 * site default — never reconstruct the whole Metadata object by hand.
 *   export const metadata = generateSEO({ title: "Services", url: "/services" });
 */
