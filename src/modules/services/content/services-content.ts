...
export interface Service {
  ...
  heroImage: string;
  cardImage: string;
  overviewImages: { main: string; secondary: string };
...
export const services: Service[] = [
  {
    ...
    overviewImages: { main: IMG.seatDiamond, secondary: IMG.seatWood },
    ...
    process: [
      { title: "Consultation", description: "We assess your seats and talk through material, color and stitching options." },
      { title: "Material selection", description: "Choose fabric, leather or a custom combination, with samples on hand." },
      { title: "Cutting & stitching", description: "Panels are hand-cut to your seat's exact pattern and precision-stitched." },
      { title: "Fitting & quality check", description: "Seats are refitted, tensioned and inspected before your car leaves the shop." },
    ],
  ...
  },
  {
    ...
    overviewImages: { main: IMG.headliner, secondary: IMG.workshop },
  ...
  },
  {
    ...
    overviewImages: { main: IMG.doorPanel, secondary: IMG.seatWood },
    ...
    process: [
      { title: "Panel removal", description: "Doors are opened up carefully, with all clips and connectors kept safe." },
      { title: "Pattern matching", description: "We map the original panel to cut new material precisely." },
      { title: "Trimming & stitching", description: "Panels are re-covered and stitched to match the rest of the cabin." },
      { title: "Refitting", description: "Everything is reassembled and function-tested — switches, handles, speakers." },
    ],
  ...
  },
  {
    ...
    overviewImages: { main: IMG.steeringWheel, secondary: IMG.seatDiamond },
  ...
  },
  {
    ...
    overviewImages: { main: IMG.workshop, secondary: IMG.seatVintageRed },
    ...
    process: [
      ...
      { title: "Final detail", description: "The finished cabin is cleaned and inspected as a whole, not piece by piece." },
    ],
  ...
  },
  {
    ...
    overviewImages: { main: IMG.customOrange, secondary: IMG.seatQuilted },
